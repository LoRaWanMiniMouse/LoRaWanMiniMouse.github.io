/*!
 * \file      User Define File 
 *
 * \brief     Parameters user platform dependent. Have to be set by the User
 *
...
#define CRYSTAL_ERROR              5 // Crystal error of the MCU to fine adjust the rx window for lorawan ( ex: set 3² for a crystal error = 0.3%)
